...
api.add_resource(onyankoButtonJson.getCategory, "/api/onyanko/category")
api.add_resource(onyankoButtonJson.getContentsNames, "/api/onyanko/names")
api.add_resource(onyankoButtonJson.getContentsURL, "/api/onyanko/voiceurl")
